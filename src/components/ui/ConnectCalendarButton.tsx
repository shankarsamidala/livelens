        ...
        return (
            <motion.div
                ...
                className={`
                    ...
                    overflow-hidden
                    select-none
                    bg-[linear-gradient(135deg,rgba(255,255,255,0.12)_0%,rgba(255,255,255,0.05)_50%,rgba(255,255,255,0.02)_100%)] backdrop-blur-[16px]
                    ${className}
                `}
                style={{
                    boxShadow: `0 8px 32px -4px rgba(139, 92, 246, 0.25), 0 2px 8px -1px rgba(124, 58, 237, 0.3), inset 0 1px 0 0 rgba(255, 255, 255, 0.4), inset 0 -2px 1px 0 rgba(109, 40, 217, 0.15)`,
                }}
            >
    ...
    return (
        <button
            ...
            className={`
                ...
                active:scale-[0.98]
                overflow-hidden
                bg-[rgba(60,20,80,0.4)] backdrop-blur-[14px] text-[#F4F6FA]
        ...
        >
            ...
            <div className="absolute inset-0 rounded-full pointer-events-none shadow-[inset_0_1px_0_0_rgba(255,255,255,0.08)]" />
            ...
            <span className="relative z-10 flex items-center gap-2.5 font-semibold">
                ...
                {!loading && (
                    <ArrowRight
                        size={13}
                        className="transition-transform group-hover:translate-x-0.5 text-[rgba(244,246,250,0.9)]"
                    />
                )}
            </span>
        </button>
