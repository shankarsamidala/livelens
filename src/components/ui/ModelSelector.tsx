...
import { STANDARD_CLOUD_MODELS, prettifyModelId, getModelDisplayName } from '../../utils/modelUtils';
...
export const ModelSelector: React.FC<ModelSelectorProps> = ({ currentModel, onSelectModel }) => {
    ...
    const displayName = (model: string) => getModelDisplayName(model, cloudModels, customProviders);
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            >
                <span className="truncate">{displayName(currentModel)}</span>
                <ChevronDown
                    size={14}
                            ...
                            <div className="space-y-1">
                                {cloudModels.length === 0 ? (
                                    ...
                                    cloudModels.map((m, idx) => {
                                        ...
                                        const icon =
                                            m.provider === 'gemini' ? <Monitor size={14} /> : <Cloud size={14} />;
                                        return (
