...
import {
    ...
    MessageSquare, Briefcase, Eye, EyeOff, Ghost, ChevronDown, ChevronRight, HelpCircle, Upload,
                    ...
                    <div className="flex items-center gap-2 rounded-full backdrop-blur-md pl-1.5 pr-1.5 py-1.5 bg-bg-item-surface border border-border-subtle shadow-sm">
                        ...
                        <div className="w-8 h-8 rounded-full bg-bg-item-active flex items-center justify-center border border-border-muted overflow-hidden">
                            <img
                                src={nativelyIcon}
                                alt="LiveLens"
                                className={`w-[20px] h-[20px] object-contain brightness-0 opacity-90 ${!isLight ? 'invert' : ''}`}
                            />
                        </div>
                        {/* Center Segment */}
    ...
    return (
        <div className="flex justify-center flex-col items-center gap-4 py-8 bg-bg-card rounded-xl border border-border-subtle relative overflow-hidden h-[240px]">
             <div className="w-[300px] bg-bg-elevated border border-border-subtle rounded-xl shadow-lg p-4 z-10">
                ...
                <div className="flex justify-between items-center">
                    <div className="flex items-center gap-2">
                        <img src={nativelyIcon} alt="LiveLens" className="w-6 h-6 object-contain rounded drop-shadow-sm opacity-90" />
                        <span className="text-text-primary text-sm font-medium">LiveLens</span>
                    </div>
            ...
            <div className="text-xs text-text-secondary text-center max-w-[280px]">
                LiveLens requires Accessibility and Screen Recording permissions to analyze screen context.
            </div>
        </div>
    );
};
...
const MockProviderSelectionAnim = () => {
    ...
    const options = [
        { id: 'natively', label: 'LiveLens API', badge: '', recommended: true, desc: 'Ultra-fast low latency transcription', color: 'indigo', icon: <img src={nativelyIcon} className={`w-[14px] h-[14px] object-contain opacity-80 ${isLight ? '' : 'filter brightness-0 invert'}`} alt="LiveLens"/> },
    ...
    const steps = [
        {
            ...
            desc: 'Enable Screen Recording and Accessibility for LiveLens in macOS Privacy & Security.',
        },
        {
            title: 'Set Up Audio',
            desc: 'Open Settings → Audio and select LiveLens API, or paste a Deepgram or Google key.',
        },
        {
    ...
    return (
        <div className="mb-10">
            <div className="mb-7">
                ...
                <p className="text-[13px] text-text-tertiary mt-0.5">Get LiveLens running in four steps.</p>
            </div>
                    ...
                    return (
                        <div key={i} className="flex gap-4">
                            ...
                            <div className="flex flex-col items-center shrink-0 w-7">
                                ...
                                {!isLast && (
                                    <div className="w-px bg-border-subtle flex-1 min-h-8 mt-[5px] mb-[5px]" />
                                )}
                            </div>

                            {/* Content */}
                            <div className={`flex-1 min-w-0 pt-[3px] ${isLast ? 'pb-0' : 'pb-6'}`}>
        ...
        <div className="w-full h-full flex flex-col animated fadeIn pb-10">
            <div className="mb-6 shrink-0">
                ...
                <p className={`text-sm text-text-secondary mt-3 max-w-2xl`}>
                    Learn how to deeply configure LiveLens. Everything from providing the right API scopes to executing conversational interviews seamlessly is covered below.
                </p>
            </div>
            ...
            <div className="flex-1 space-y-2">
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 flex-1">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-[13px] text-text-secondary">
                                    Use the <span className="font-semibold text-text-primary">LiveLens API</span> for an out-of-the-box experience. One-click zero-configuration usage.
                                </p>
                            </div>
                        </div>
                ...
                <AccordionSection title="1. App Permissions Setup" icon={<Monitor className="w-4 h-4" />}>
                     <div className="space-y-4">
                        <p>LiveLens operates entirely on-device, but requires OS permissions to tap into your screen context and global keystrokes. Here is how your system should look:</p>
                        <MockPermissionsAnim />
                    <div className="space-y-3 mt-4">
                            ...
                            <div className={`p-4 rounded-xl border bg-bg-item-surface border-border-subtle space-y-2`}>
                                ...
                                <p className="text-[11px] opacity-90 leading-relaxed text-text-secondary">
                                    LiveLens can capture both what you say and what you hear globally. At the top of the Audio Settings, use the Dropdowns to explicitly select your hardware Input (e.g. your physical microphone) and Output capture (what the speakers play). By default, LiveLens utilizes the <strong>System Default</strong>, so audio routing will automatically follow your OS preferences.
                                </p>
                            </div>
                        ...
                        <div className="flex flex-col gap-3 mt-6">
                            <div className={`p-4 rounded-xl border bg-bg-item-surface border-border-subtle`}>
                                ...
                                <p className="text-xs opacity-90 mb-2">Provides LiveLens the ability to read your screen temporarily when you capture context.</p>
                            ...
                            <div className={`p-4 rounded-xl border bg-bg-item-surface border-border-subtle`}>
                                ...
                                <p className="text-xs opacity-90 mb-2">Required for LiveLens to detect the global keyboard shortcuts below, regardless of what window is focused.</p>
                ...
                <AccordionSection title="2. Audio STT Providers Setup (Microphone)" icon={<Mic className="w-4 h-4" />}>
                     <div className="space-y-6">
                        <p>LiveLens supports over 8 different Audio engines to transcribe what you hear and say. From the Audio tab in settings, use the overarching dropdown to switch the active engine.</p>
                ...
                <AccordionSection title="3. AI Providers & Prompt Engine" icon={<Key className="w-4 h-4" />}>
                     <div className="space-y-4">
                        <p className="text-sm">LiveLens uses Large Language Models (LLMs) to reason about your screen and audio context. You can configure cloud providers, local models, or fully custom endpoints.</p>
                        ...
                        <div className="space-y-3 pt-2">
                             ...
                             <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                 ...
                                 <div className="p-3 rounded-xl border bg-bg-item-surface border-border-subtle hover:border-border-muted transition-colors">
                                     <h5 className="font-semibold text-sm text-text-primary flex justify-between items-center mb-1">
                                         <span className="flex items-center gap-2">
                                            <img src="https://cdn.simpleicons.org/anthropic/000000" alt="Anthropic" className={`w-4 h-4 object-contain ${!isLight ? 'invert' : ''}`} /> Anthropic
                                         </span>
                        ...
                        <div className="space-y-3 pt-4">
                             ...
                             <div className="p-4 rounded-xl border bg-bg-item-surface border-border-subtle space-y-3">
                                 <p className="text-xs opacity-90 leading-relaxed text-text-secondary">
                                     You can run LiveLens completely offline with 100% data privacy using Ollama. LiveLens automatically scans <span className={kbdClass}>http://localhost:11434</span> for active models.
                                 </p>
                                 <ol className="list-decimal pl-4 text-xs space-y-2 opacity-90 text-text-secondary">
                                     ...
                                     <li>Return to LiveLens's AI Providers overlay, and you will see your Local models ready for usage.</li>
                                 </ol>
                             </div>
                        </div>
                             ...
                             <div className="p-4 rounded-xl border bg-bg-item-surface border-border-subtle space-y-3">
                                 ...
                                 <div className="flex items-start gap-2 mt-2">
                                     ...
                                     <div className="text-xs text-text-secondary leading-relaxed">
                                         <strong>Crucial: The Response Path.</strong> You must inform LiveLens how to parse the JSON text back. Deeply nested outputs must define the exact path array. For OpenAI/OpenRouter compliant endpoints, this is strictly: <span className={kbdClass}>choices[0].message.content</span>.
                                     </div>
                                 </div>
                             </div>
                        </div>
                ...
                <AccordionSection title="4. LiveLens Interface Operations" icon={<Monitor className="w-4 h-4" />}>
                     <div className="space-y-6">
                        <p className="text-[13px]">When initialized, LiveLens hides itself visually while remaining active as a persistent translucent overlay. This is your command center.</p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                            <div className="p-4 bg-bg-item-surface border border-border-subtle rounded-xl shadow-sm hover:border-border-muted transition-colors group">
                                ...
                                <p className="text-[12px] text-text-secondary leading-relaxed">
                                    LiveLens fires a local background job as soon as the meeting finishes to compress the entire raw audio transcript into clean, formatted markdown representing structural overviews and explicit action items.
                                </p>
                            </div>
                ...
                <AccordionSection title="6. Global Search & Shortcuts" icon={<Search className="w-4 h-4" />}>
                     <div className="space-y-6">
                        <p className="text-[13px]">Hit <span className={kbdClass}>Cmd+K</span> anywhere on your computer to invoke the LiveLens Global Palette. This acts as your Spotlight overlay for interacting directly with the system backbone.</p>
                        ...
                        <div className="border-t border-border-subtle pt-6">
                            ...
                            <p className="text-[11px] text-text-secondary mt-1 mb-3">These hotkeys work anywhere on your operating system, regardless of whether LiveLens is focused or completely hidden. Change them via <strong>Settings &gt; Hotkeys</strong>.</p>
                                 ...
                                 <div className="flex items-center justify-between p-4 rounded-xl border bg-bg-item-surface border-border-subtle group">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-xs text-text-secondary mt-1">Triggers LiveLens to analyze the captured screenshots and text from the rolling buffer.</div>
                                        </div>
                                    </div>
                                    <div className="flex gap-1 shrink-0">
                            ...
                            <div className="grid md:grid-cols-2 gap-3">
                                ...
                                <div className="p-4 rounded-xl border bg-accent-primary/5 border-border-subtle">
                                    ...
                                    <p className="text-[11px] text-text-secondary mb-2">
                                        This is a LiveLens Pro feature. 
                                    </p>
                ...
                <AccordionSection title="8. Modes Manager" icon={<LayoutGrid className="w-4 h-4" />}>
                    <div className="space-y-6">
                            ...
                            <div className="grid md:grid-cols-2 gap-3">
                                <div className="p-4 rounded-xl border bg-bg-item-surface border-border-subtle">
                                    ...
                                    <ul className="text-[11px] text-text-secondary space-y-1 list-disc pl-4">
                                        ...
                                        <li>Requires a LiveLens Pro license</li>
                                    </ul>
                                </div>
                                <div className="p-4 rounded-xl border bg-bg-item-surface border-border-subtle">
                                ...
                                <div className="p-4 rounded-xl border bg-bg-item-surface border-border-subtle">
                                    ...
                                    <ul className="text-[11px] text-text-secondary space-y-1 list-disc pl-4">
                                        ...
                                        <li>Or use <strong>LiveLens Templates</strong> for a preset start</li>
                        ...
                        <div className="p-3 bg-indigo-500/10 border border-indigo-500/20 rounded-xl">
                            ...
                            <p className="text-[11px] text-text-secondary leading-relaxed mb-0">
                                Modes are locked behind LiveLens Pro. Free and trial users see only the General mode. Activate a license via <strong>Settings → LiveLens API</strong> to unlock all seven modes.
                            </p>
                        </div>
                    </div>
                </AccordionSection>
                    ...
                    <div className="space-y-6">
                        ...
                        <div>
                            <div className="p-3 bg-blue-500/10 border border-blue-500/20 rounded-xl mb-4">
                                ...
                                <p className="text-[11px] text-text-secondary leading-relaxed mb-0">
                                    By connecting your Google Calendar directly to LiveLens, the AI automatically gains context on your upcoming meetings, syncs the event data, and reads attendee lists to hyper-personalize your interactions.
                                </p>
                            </div>
                            ...
                            <div className="grid md:grid-cols-2 gap-3">
                                <div className="p-4 rounded-xl border bg-bg-item-surface border-border-subtle">
                                    ...
                                    <ul className="text-[11px] text-text-secondary space-y-1 list-disc pl-4">
                                        ...
                                        <li>LiveLens will quietly background-sync your schedule.</li>
                                    </ul>
                                </div>
                                <div className="p-4 rounded-xl border bg-bg-item-surface border-border-subtle">
                                    <h4 className="font-semibold text-sm mb-2 text-text-primary">Follow-Up System</h4>
                                    <p className="text-[11px] text-text-secondary">
                                        When tracking live meetings, LiveLens uses the connected calendar context to instantly figure out <strong>who you are talking to</strong>. This powers the Follow-Up Email system, letting you auto-draft post-meeting notes to confirmed attendees.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <AccordionSection title="10. Stealth & Window Control" icon={<Ghost className="w-4 h-4" />}>
                     <div className="space-y-4">
                        <div className="p-3 bg-indigo-500/10 border border-indigo-500/20 rounded-xl mb-4">
                            ...
                            <p className="text-[11px] text-text-secondary leading-relaxed mb-0">
                                LiveLens is heavily geared towards power users seeking minimalistic operation. The process completely disguises itself and remains undetectable/invisible to standard screen-recording applications and desktop sharing utilities.
                            </p>
                        </div>
                            ...
                            <div className="p-4 rounded-xl border bg-bg-item-surface border-border-subtle group">
                                ...
                                <div className="p-2 border border-orange-500/20 bg-orange-500/5 rounded-lg">
                                    <p className="text-[10px] text-orange-400 m-0">
                                        <strong>⚠️ Warning:</strong> This renders the LiveLens overlay completely unclickable. You MUST memorize the Global Hotkeys (e.g. <strong>Cmd+Shift+Arrows</strong> to move, <strong>Cmd+B</strong> to hide, <strong>Cmd+1-7</strong> for actions) to control the application once this is active.
                                    </p>
                                </div>
                            </div>
                        </div>
