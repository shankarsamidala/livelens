...
// ── Inline-style design tokens ──────────────────────────────────────────────
const D = {
    panelBgDark:       '#0d0f14',
    panelBgLight:      '#F3F4F6',
    borderDark:        'rgba(255,255,255,0.09)',
    borderLight:       'rgba(0,0,0,0.10)',
    shadowDark:        '0 24px 48px rgba(0,0,0,0.85), 0 0 0 1px rgba(255,255,255,0.04)',
    shadowLight:       '0 4px 16px rgba(0,0,0,0.10)',
...
// ── Icon wrapper ──────────────────────────────────────────────────────────────
const Ic = ({ color, dim, isLight }: { color?: string; dim?: boolean; isLight: boolean }) => ({
    ...
    return (
        <div style={{ background: 'transparent' }}>
            ...
            >
                ...
                {/* Fast Response */}
                <Row isLight={isLight} disabled={!fastTextEnabled} title={!fastTextEnabled ? 'Requires Groq or LiveLens API key' : ''}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 9, flex: 1, minWidth: 0 }}>
                        <Zap style={Ic({ color: useGroqFastText ? '#f97316' : undefined, isLight })} />
