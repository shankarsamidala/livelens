                ...
                <div className="relative">
                    ...
                    >
                        ...
                        <div className="relative" ref={pillRef}>
                            <div
                                className="relative overflow-hidden rounded-[12px] border border-white/[0.09] backdrop-blur-[20px] bg-[rgba(13,15,20,0.92)]"
                            ...
                            >
                                ...
                                >
                                    <div className="absolute left-3 flex items-center pointer-events-none">
                                        <Search size={13} className="text-[rgba(226,229,237,0.30)]" />
                                    </div>
                                    <input
                                        ref={inputRef}
                                        type="text"
                                        ...
                                        className="w-full bg-transparent pl-[34px] pr-4 py-[7px] text-[13px] focus:outline-none text-[rgba(226,229,237,0.85)]"
                                    ...
                                    {showResults && (
                                        ...
                                        >
                                            <div className="w-[480px]">
                                                <div className="py-2 border-t border-white/[0.07]">
                                                    {/* Explore Section */}
                                                    <div className="px-2 pb-1">
                                                        <div className="px-2 pb-1 text-[10px] font-[700] tracking-[0.08em] uppercase text-[rgba(226,229,237,0.22)]">
                                                            Explore
                                                        </div>
                                                        {/* AI Query */}
                                                        <motion.button
                                                            initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.15 }}
                                                            className={`w-full flex items-center gap-3 px-2 py-[7px] rounded-[8px] text-left transition-colors duration-100 ${selectedIndex === 0 ? 'bg-white/[0.07]' : 'bg-transparent'}`}
                                                        ...
                                                        <motion.button
                                                            ...
                                                            className={`w-full flex items-center gap-3 px-2 py-[7px] rounded-[8px] text-left transition-colors duration-100 ${selectedIndex === 1 ? 'bg-white/[0.07]' : 'bg-transparent'}`}
                                                            ...
                                                            <AnimatePresence initial={false} mode="popLayout">
                                                                {sessionResults.map((result, index) => (
                                                                    <motion.button
                                                                        ...
                                                                        transition={{ duration: 0.15 }}
                                                                        className={`w-full flex items-center gap-3 px-2 py-[7px] rounded-[8px] text-left transition-colors duration-100 ${selectedIndex === index + 2 ? 'bg-white/[0.07]' : 'bg-transparent'}`}
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <div className="flex-1 min-w-0">
                                                                            <div className="text-[12.5px] truncate text-[rgba(226,229,237,0.80)]">{result.title}</div>
                                                                            {result.subtitle && (
                                                                                <div className="text-[11px] text-[rgba(226,229,237,0.30)]">{result.subtitle}</div>
                                                                            )}
                                                                        </div>
                                                                    </motion.button>
                                                                ))}
